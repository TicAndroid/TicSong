...
import com.ticcorp.ticsong.retrofit2Interface.RegisterInterface;
...
public class RegisterController {
    ...
    public boolean register(final Activity activity, String userId, String name, String platform) {
        /*
        원래코드
