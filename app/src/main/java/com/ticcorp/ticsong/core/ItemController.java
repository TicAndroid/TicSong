...
import com.ticcorp.ticsong.DTO.ItemDTO;

import com.ticcorp.ticsong.StaticInfo;
import com.ticcorp.ticsong.model.CustomPreference;
import com.ticcorp.ticsong.retrofit2Interface.ItemInterface;
...
public class ItemController {
    ...
    public boolean getItem(final Activity activity, String userId) {
        /*
        원래코드
...
*/
    ...
    public boolean insertItem(final Activity activity, String userId, int item1Cnt, int item2Cnt, int item3Cnt,int item4Cnt) {
        /*
        원래코드
