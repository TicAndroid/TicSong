...
public class MainActivity$$ViewBinder<T extends com.ticcorp.ticsong.MainActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558554, "field 'btn_ranking' and method 'rankingClicked'");
    target.btn_ranking = finder.castView(view, 2131558554, "field 'btn_ranking'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131558555, "field 'btn_setting'");
    target.btn_setting = finder.castView(view, 2131558555, "field 'btn_setting'");
    view = finder.findRequiredView(source, 2131558557, "field 'img_juke_bold'");
    target.img_juke_bold = finder.castView(view, 2131558557, "field 'img_juke_bold'");
    view = finder.findRequiredView(source, 2131558556, "field 'img_juke_sport'");
    target.img_juke_sport = finder.castView(view, 2131558556, "field 'img_juke_sport'");
    ...
    target.profile_img = finder.castView(view, 2131558549, "field 'profile_img'");
  }
