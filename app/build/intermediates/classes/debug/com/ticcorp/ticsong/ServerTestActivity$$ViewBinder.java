...
public class ServerTestActivity$$ViewBinder<T extends com.ticcorp.ticsong.ServerTestActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131427491, "field 'selectBtn' and method 'selectBtnClicked'");
    target.selectBtn = finder.castView(view, 2131427491, "field 'selectBtn'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131427490, "field 'friendBtn' and method 'friendBtnClicked'");
    target.friendBtn = finder.castView(view, 2131427490, "field 'friendBtn'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
